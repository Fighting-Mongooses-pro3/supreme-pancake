    ...
    <div>
      <div className="border rounded-md border-black mx-auto bg-blue-200">
        <p className="text-center">
          ...
          many characters are at that level currently. You can then add more
          rows for each unique level of characters that comprise the party.
          <br></br>
          <br></br>
          For example, we will take a party of five characters, three of which
          are level 8, and two of which are level 9. There are two different
          levels represented here so you would need two rows. One row would have
          the character level field set to 8, and the number of characters field
          set to 3. The second row would have the character level field set to
          9, and the number of characters field set to 2. Once these fields have
          been input, you will see that the difficulty level fields below will
      ...
      <br></br>
      <br></br>
      <div className="border rounded-3xl border-black mx-auto bg-green-200">
