...
export const HeroC = (props) => {
  return (
    <background className="">
      <section
        className={`bg-white overflow-hidden bg-opacity-90 grid grid-flow-col grid-cols-6 gap-2 rounded-3xl transform translate-x-52 ${props.customCss}`}
      >
