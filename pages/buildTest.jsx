...
export default function buildTest() {
  ...
  function render(){
    ...
    setComponents(cardInfo.map(e=>{return <Draggable grid={[gridX/2, 20]} scale={1}><div id='card1'  className='relative left-5 top-5 w-2/5 h-1/4 border'>{e.text}</div></Draggable> }))
  ...
  return (
    <div className='flex justify-center items-center h-screen'>
      <div>
      <button className='border' onClick={()=>render()}>render</button> <br />
