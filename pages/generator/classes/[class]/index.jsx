          ...
          <Container>
            ...
            <section>
              <p>
                ...
                granted new abilities and features. Below you'll find a guide
                for understanding what your {dndClass.index} is given at each
                level.
                {dndClass.class_levels}
                If your character is starting over level 1, there is a chance
                that you might want to multi-class into {dndClass.index}. Below
                you'll find a guide to what prerequisite your character needs to
                have in order to be able to multi-class into {dndClass.index},
                as well as a list of proficiencies that are added to your
                character if they do not already have them. We recommend
                consulting with your DM before multi-classing.
