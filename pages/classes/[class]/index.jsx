      ...
      <Container>
        ...
        <section>
          <p>
            ...
            during a short rest. Your class allows you to select beginning skill
            proficiencies from a given set of options.{" "}
            {dndClass[0].proficiency_choices.desc}
            Along with skills, your character class comes with proficiencies in
            weapons, armor, saving throws, and possibly some extras. The
            ...
            {dndClass.index}. We recommend speaking with your DM to see if there
            are any additions or exclusions to go with this list for your
            starting character.
            {dndClass.starting_equipment}
            {dndClass.starting_equipment_options}
            As you level up your {dndClass.index}, your character may be granted
            new abilities and features. Below you'll find a guide for
            ...
            order to be able to multi-class into {dndClass.index}, as well as a
            list of proficiencies that are added to your character if they do
            not already have them. We recommend consulting with your DM before
            multi-classing.
            {dndClass.multi_classing}
            Depending on your starting level and class, your character might be
            given the option of taking a subclass already. Below you'll find an
            example of a subclass for the {dndClass.index}.{dndClass.subclasses}
          </p>
        </section>
      </Container>
    ) : null}
