        ...
        <Body>
          <div>
            <p>
              ...
              a given level. We have provided rows below the table that will
              allow you to input an XP threshold from this table and multiply
              that number by the number of players at the associated level. All
              of these XP Threshold totals will be combined to figure out the
              total XP Threshold number for the entirety of the party.
            </p>
            ...
            <p>
              Below you'll find a field to input an XP Threshold pulled from the
              table above, and a second field to input the number of players
              equal to that XP Threshold's corresponding player level. These two
              numbers multiplied together will show the total XP Threshold for
              the party.
              <br></br>
              We have supplied multiple rows in order to allow for a variety of
              possible party level compositions. All of the XP Threshold totals
              by party level will be combined and shown in the 'Total XP
              Threshold' field at the bottom.
            </p>
            <form>
              <label for="init1">XP Threshold:</label>
              ...
              <button onclick={multi("init1", "chars1", "xpDisplay")}>
                Calculate
              </button>
              <label>
                Total XP Threshold for associated level:
                <span id="xpDisplay"></span>
              </label>

              <br></br>
              <label for="init2">XP Threshold:</label>
              ...
              <br></br>
              <label for="init3">XP Threshold:</label>
              ...
              <br></br>
              <label for="init4">XP Threshold:</label>
              ...
              <br></br>
              <label for="init5">XP Threshold:</label>
              ...
              <br></br>
              <label for="init6">XP Threshold:</label>
              ...
              <br></br>
              <label for="init7">XP Threshold:</label>
